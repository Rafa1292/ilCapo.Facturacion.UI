...
const Home = () => {
  ...
  return (
    <Content isLoading={isLoading}>
      ...
      <LeftViewBar tableNumber={5} top={15} left={30}/>
      <LeftViewBar tableNumber={6} top={30} left={30}/>
      <LeftViewBar tableNumber={7} top={45} left={30}/>
      <LeftViewBar tableNumber={8} top={60} left={30}/>
      <LeftViewBar tableNumber={9} top={75} left={30}/>
      <LeftViewBar tableNumber={10} top={90} left={30}/>
    </Content>
  )
}
